  ...
  return (
    <InfoPageLayout>
      <div className="overflow-auto bg-white text-black p-3 rounded-md">
        ...
        <p>
          At Cyber Chaos Cards, accessible from https://cyberchaoscards.com, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by Cyber Chaos Cards and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in Cyber Chaos Cards. This policy is not
        ...
        <p>
          Cyber Chaos Cards follows a standard procedure of using log files.
        ...
        <p>
          ...
          advertising partners of Cyber Chaos Cards.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Cyber Chaos Cards, which are
        ...
        <p>
          Note that Cyber Chaos Cards has no access to or control over these
          cookies that are used by third-party advertisers.
        </p>
        <div className="divider" />
        <h2 className="text-xl font-bold">Third Party Privacy Policies</h2>
        <p>
          Cyber Chaos Cards&apos;s Privacy Policy does not apply to other
        ...
        <p>
          Cyber Chaos Cards does not knowingly collect any Personal Identifiable
